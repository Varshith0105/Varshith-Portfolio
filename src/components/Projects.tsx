...
const projects = [
  ...
  {
  title: "Personal AI Chat Application",
  description: "Real-time AI chatbot that delivers context-aware responses with a smooth conversational interface and chat history support.",
  tech: ["React", "TypeScript", "Tailwind CSS", "Vite", "OpenAI API"],
